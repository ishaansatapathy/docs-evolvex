  ...
  return (
    ...
    >
      ...
      <style dangerouslySetInnerHTML={{ __html: `
        ...
        html:has(.thread-page) #main-content + footer,
        html:has(.thread-page) #main-content ~ footer,
        html:has(.thread-page) .thally-docs-main + footer,
        html:has(.thread-page) .thally-docs-shell > div > footer,
        html:has(.thread-page) .thally-docs-shell > div > footer *,
        body:has(.thread-page) #main-content + footer,
        body:has(.thread-page) #main-content ~ footer,
        body:has(.thread-page) .thally-docs-main + footer,
        body:has(.thread-page) .thally-docs-shell > div > footer,
        body:has(.thread-page) .thally-docs-shell > div > footer *,
        body.evolvex-landing-active #main-content + footer,
        body.evolvex-landing-active #main-content ~ footer,
        body.evolvex-landing-active .thally-docs-main + footer,
